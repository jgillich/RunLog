...
module.exports = AmpersandView.extend({
    ...
    template: `
        <div>
            <header class="bar bar-nav">
                <a class="icon icon-list pull-right" href="#activities" data-transition="slide-in"></a>
    ...
    stop: function () {
        ...
        var distance = 0;
        for(var i = 1; i < this.model.checkpoints.length; i++) {
            distance += leaflet.latLng(this.model.checkpoints[i-1]).distanceTo(this.model.checkpoints[1]);
        }
